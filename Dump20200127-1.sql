...
CREATE TABLE `posteos` (
  ...
  `id_cl_posteo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_posteo`),
  KEY `id_cl_posteo` (`id_cl_posteo`),
  CONSTRAINT `posteos_ibfk_1` FOREIGN KEY (`id_cl_posteo`) REFERENCES `clientes` (`id_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-27 16:56:08
