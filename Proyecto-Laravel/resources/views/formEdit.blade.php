...
<div class="form-group row">
  ...
  <div class="col-md-6">
    <select id="name" type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{$user->country}}" required autocomplete="name" autofocus>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-6">
          <input id="name" type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" autocomplete="name" autofocus>
    ...
    <div class="card-header text-center">Here you can change the Password of this User</div>
    <div class="card-body">                 
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-6">
        <input id="confirmPassword" type="password" class="form-control" name="confirmPassword" autocomplete="new-password">
      </div>
    </div>
    </div>
